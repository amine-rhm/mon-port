...
export const projectsData = [
  ...
  },
  {
    id: 6,
    title: "Soutenplan",
    description: "Plateforme numérique complète de gestion des soutenances de Master MIAGE développée pour l'Université de Picardie Jules Verne. Cette solution innovante digitalise et optimise l'ensemble du processus de soutenance en offrant une gestion centralisée des plannings, une saisie simplifiée des notes, un système de signature électronique et une coordination efficace entre étudiants, enseignants et jury. L'interface intuitive facilite l'organisation académique tout en garantissant la traçabilité des évaluations.",
